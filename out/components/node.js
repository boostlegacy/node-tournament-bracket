...
class Node {
    constructor({ name = "", team_upper = null, team_lower = null, next_node = null, upper_node = null, lower_node = null, round = -1, upper_wins = 0, lower_wins = 0, best_of = 1 } = {}) {
        this.name = name;
    ...
    dq_team(dq_team) {
        if (this.team_upper !== null && this.team_lower !== null) {
            let round_win = { round: this.round, bracket_location: this.name, win: true, wins: 0, losses: 0 };
            let round_lose = { round: this.round, bracket_location: this.name, win: false, wins: -1, losses: 0 };
    ...
    declare_single_win(winner) {
        ...
        if (this.upper_wins > this.best_of / 2 || this.lower_wins > this.best_of / 2) {
            if (this.team_upper !== null && this.team_lower !== null) {
                ...
                let round_win = { round: this.round, bracket_location: this.name, win: true, wins: round_winner_wins, losses: round_winner_losses };
                let round_lose = { round: this.round, bracket_location: this.name, win: false, wins: round_loser_wins, losses: round_loser_losses };
